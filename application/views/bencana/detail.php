			...
			<div class="col-sm-6">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h4 class="card-title">Lokasi Bencana</h4>
					</div>
					<div class="box-body">
					...
					<div class="box-body">
						<table class="table table-striped table-bordered">
							...
							<tr>
								...
								<td>:</td>
								<td><?= $bencana->kerugian; ?></td>
							</tr>
							<tr>
								<td>Gambar</td>
								<td>:</td>
								<td> <img src="<?= base_url(); ?>assets_style/file/<?php echo $bencana->foto; ?>" class="img-responsive" style="height:auto;width:250px;" /></td>
							</tr>
						</table>
					</div>
				</div>
...
<script>
	...
	var map = L.map('map', {
		center: [<?= $bencana->latitude ?>, <?= $bencana->longitude ?>],
		zoom: 16,
		layers: [peta2, bencana]
	});
	...
	L.geoJSON({
		...
		"features": [<?= $bencana->bencana_geojson; ?>]
	}, {
		style: {
			color: "<?= $bencana->warna ?>",
			fillOpacity: 0.4,
